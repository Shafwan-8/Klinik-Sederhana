...
class MailDokterController extends Controller
{
    /**
    ...
    {        
        ...
        $listSurat = Mail::where('type_id', 1)->get();
    ...
    public function store(Request $request)
    {
        ...
        $request->request->add(['uuid' => $uuid, 'type_id' => 1]);
        ...
        return to_route('keterangan-dokter.index')->with('success', 'Data Surat Dokter berhasil disimpan.');
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        return to_route('keterangan-dokter.index')->with('success', 'Data Surat Dokter berhasil disunting.');
