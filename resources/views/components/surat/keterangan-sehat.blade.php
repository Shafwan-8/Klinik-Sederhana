    ...
    <div class="mt-3">
        ...
        <style>
            table {
                ...
                /* Untuk menggabungkan border sel-sel tabel */
            }

            td {
                padding: 10px;
                /* Atur jarak antara isi sel dan tepi sel */
                border: 1px solid black;
                /* Contoh border untuk sel-sel */
            }
        </style>
        ...
        <p class="my-3">Telah dilakukan pemeriksaan kesehatan dengan teliti dan menyatakan bahwa, yang bersangkutan
            dalam keadaan : </p>

        <div class="text-center my-4">
            <h3 class="font-weight-bold">SEHAT / TIDAK SEHAT SEMENTARA WAKTU / TIDAK SEHAT</h3>
        </div>
