...
@section('title')
<h3>Grafik Layanan</h3>
@endsection

@section('container')
    <form action="{{ route('grafik.layanan') }}" method="GET">
        <div class="row">
            <div class="col-sm-2">
    ...
    @if($tahun)
    <canvas id="layananChart" width="400" height="200" class="mt-5"></canvas>
    @else
...
@section('footerJs')
    var ctxLayanan = document.getElementById('layananChart').getContext('2d');
    var myLayananChart = new Chart(ctxLayanan, {
        type: 'bar',
        data: {
