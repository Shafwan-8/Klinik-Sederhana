                ...
                <tbody class="text-dark">
                    @forelse ($dataIcdx as $icdx)
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="{{ route('icdx.edit', $icdx->icId) }}" class="badge bg-warning"><span data-feather="edit"></span></a>
                                <a class="badge bg-danger" onclick="hapusData('icdx', '{{ $icdx->icId }}')"><span data-feather="trash-2"></span></a>
                                <form
                                    id="hapus-icdx-{{ $icdx->icId }}"
                                    style="display: none"
                                    action="{{ route('icdx.destroy', $icdx->icId) }}"
                                    method="post"
                                >
                                    @csrf
                                    @method('delete')
